...
export default class TutorialIntroScreens extends React.Component {
    ...
    handleNext = () => {
        ...
        case 0:
            trackEvent('tutorial', 'tutorial_screen_1_welcome_to_tfchat_next');
            break;
        case 1:
            trackEvent('tutorial', 'tutorial_screen_2_how_tfchat_works_next');
            break;
        case 2:
    ...
    skipTutorial = (e) => {
        ...
        switch (this.state.currentScreen) {
        case 0:
            trackEvent('tutorial', 'tutorial_screen_1_welcome_to_tfchat_skip');
            break;
        case 1:
            trackEvent('tutorial', 'tutorial_screen_2_how_tfchat_works_skip');
            break;
        case 2:
        ...
        return (
            <div id='tutorialIntroTwo'>
                <FormattedHTMLMessage
                    ...
                    defaultMessage='<h3>How TF Chat works:</h3>
