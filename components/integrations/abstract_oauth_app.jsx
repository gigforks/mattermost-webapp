                    ...
                    <div className='col-md-5 col-sm-8'>
                        ...
                        <div className='form__help'>
                            <FormattedMessage
                                ...
                                defaultMessage="When true, the OAuth 2.0 application is considered trusted by the ZeroChat server and doesn't require the user to accept authorization. When false, an additional window will appear, asking the user to accept or deny the authorization."
                            />
                        </div>
                    </div>
                </div>
