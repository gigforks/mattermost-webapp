            ...
            <BackstageList
                ...
                helpText={
                    <FormattedMessage
                        ...
                        defaultMessage='Use slash commands to connect external tools to TF Chat. {buildYourOwn} or visit the {appDirectory} to find self-hosted, third-party apps and integrations.'
                        values={{
                            buildYourOwn: (
                                <a
                                    target='_blank'
