            ...
            extraInfo = (
                <span>
                    <FormattedHTMLMessage
                        ...
                        defaultMessage='<a href="/" target="_blank">Personal access tokens</a> function similarly to session tokens and can be used by integrations to <a href="/" target="_blank">authenticate against the REST API</a>. Create new tokens on your desktop.'
                    />
                </span>
            );
        } else {
            extraInfo = (
                <span>
                    <FormattedHTMLMessage
                        ...
                        defaultMessage='<a href="/" target="_blank">Personal access tokens</a> function similarly to session tokens and can be used by integrations to <a href="/" target="_blank">authenticate against the REST API</a>.'
                    />
                </span>
            );
        }
