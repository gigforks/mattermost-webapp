                ...
                <div>
                    <p>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='Select additional permissions for the account. <a href="/" target="_blank">Read more about roles and permissions</a>.'
                        />
                    </p>
                    <div className='checkbox'>
                        <label>
                            ...
                            <FormattedMessage
                                ...
                                defaultMessage='Access to post to all ZeroChat channels including direct messages.'
                            />
                        </label>
                    </div>
                    <div className='checkbox'>
                        <label>
                            ...
                            <FormattedMessage
                                ...
                                defaultMessage='Access to post to all ZeroChat public channels.'
                            />
                        </label>
                    </div>
                </div>
                    ...
                    <div className='checkbox'>
                        <label>
                            ...
                            <FormattedHTMLMessage
                                ...
                                defaultMessage='Allow this account to generate <a href="/" target="_blank">personal access tokens</a>.'
                            />
