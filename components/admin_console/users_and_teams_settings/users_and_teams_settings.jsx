        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.team.restrictExample', 'Ex "corp.zerochat.com, zerochat.org"')}
                    helpText={
                        <FormattedMessage
                            id='admin.team.restrictDescription'
                            defaultMessage='Teams and user accounts can only be created from a specific domain (e.g. "zerochat.org") or list of comma-separated domains (e.g. "corp.ZeroChat.com, ZeroChat.org").'
                        />
                    }
                ...
                <DropdownSetting
                    ...
                    values={[
                        {value: RESTRICT_DIRECT_MESSAGE_ANY, text: Utils.localizeMessage('admin.team.restrict_direct_message_any', 'Any user on the ZeroChat server')},
