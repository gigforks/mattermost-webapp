            ...
            <div>
                ...
                <div className='padding-top x2'>
                    <FormattedHTMLMessage
                        ...
                        defaultMessage='Personal access tokens function similarly to session tokens and can be used by integrations to <a href="/" target="_blank">interact with this ZeroChat server</a>. Tokens are disabled if the user is deactivated. Learn more about <a href="/" target="_blank">personal access tokens</a>.'
                    />
                </div>
