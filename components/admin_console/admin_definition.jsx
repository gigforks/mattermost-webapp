                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text_default: 'Set to false to disable all version 3 endpoints of the REST API. Integrations that rely on API v3 will fail and can then be identified for migration to API v4. API v3 is deprecated and will be removed in the near future. See <a href="https://threefoldtoken.com" target="_blank">https://threefoldtoken.com</a> for details.',
                            help_text_html: true,
                        },
                        {
                            type: Constants.SettingsTypes.TYPE_DROPDOWN,
                    ...
                    settings: [
                        {
                            ...
                            label_default: '<h4 class="banner__heading">Note:</h4><p>Compliance is an enterprise feature. Your current license does not support Compliance. Click <a href="http://threefoldtoken.com"target="_blank">here</a> for information and pricing on enterprise licenses.</p>',
                    ...
                    settings: [
                        {
                            ...
                            label_default: '<a href=\'https://threefoldtoken.com\' target=\'_blank\'>Multi-factor authentication</a> is available for accounts with AD/LDAP or email login. If other login methods are used, MFA should be configured with the authentication provider.',
                            label_html: true,
                            banner_type: 'info',
                        },
                        {
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            help_text_default: '(Optional) Only required if you do not want to authenticate to S3 using an <a target="_blank" href="/">IAM role</a>. Enter the Access Key ID provided by your Amazon EC2 administrator.',
                        ...
                        },
                        {
                            ...
                            help_text_default: 'When true, encrypt files in Amazon S3 using server-side encryption with Amazon S3-managed keys. See <a href="/" target="_blank">documentation</a> to learn more.',
                            isHidden: needsUtils.not(needsUtils.hasLicense),
                            isDisabled: needsUtils.not(needsUtils.stateValueEqual('FileSettings.DriverName', FILE_STORAGE_DRIVER_S3)),
                        },
                        {
                        ...
                        {
                            type: Constants.SettingsTypes.TYPE_DROPDOWN,
                            key: 'FileSettings.ImageProxyType',
                            label: 'admin.image.proxyType',
                            label_default: 'Image Proxy Type:',
                            help_text: 'admin.image.proxyTypeDescription',
                            help_text_default: 'Configure an image proxy to load all Markdown images through a proxy. The image proxy prevents users from making insecure image requests, provides caching for increased performance, and automates image adjustments such as resizing. See <a href="/">documentation</a> to learn more.',
                            help_text_html: true,
                            options: [
                                {
                                    value: '',
                        ...
                        {
                            type: Constants.SettingsTypes.TYPE_TEXT,
                            key: 'FileSettings.ImageProxyURL',
                            ...
                            isDisabled: needsUtils.stateValueFalse('FileSettings.ImageProxyType'),
                        },
                        {
                            type: Constants.SettingsTypes.TYPE_TEXT,
                            key: 'FileSettings.ImageProxyOptions',
