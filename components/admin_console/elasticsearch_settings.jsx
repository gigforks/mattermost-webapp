                ...
                <RequestButton
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='Tests if the TF Chat server can connect to the Elasticsearch server specified. Testing the connection only saves the configuration if the test is successful. See log file for more detailed error messages.'
                        />
                    }
                    buttonText={
                        <FormattedMessage
