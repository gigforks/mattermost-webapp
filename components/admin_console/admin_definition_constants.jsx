    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='ZeroChat will connect over an insecure connection.'
            />
        </td>
    </tr>
);
    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='Encrypts the communication between ZeroChat and your server.'
            />
        </td>
    </tr>
);
                ...
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The ZeroChat server will serve static files compressed with gzip.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The ZeroChat server will serve static files uncompressed.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The ZeroChat server will not serve static files.'
                        />
                    </td>
                </tr>
            </tbody>
