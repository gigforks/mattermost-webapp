    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='TF Chat will connect over an insecure connection.'
            />
        </td>
    </tr>
);
    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='Encrypts the communication between TF Chat and your server.'
            />
        </td>
    </tr>
);
                ...
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The TF Chat server will serve static files compressed with gzip.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The TF Chat server will serve static files uncompressed.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The TF Chat server will not serve static files.'
                        />
                    </td>
                </tr>
            </tbody>
