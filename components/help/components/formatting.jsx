...
export default function HelpFormatting() {
    ...
    message.push('```\n' + localizeMessage('help.formatting.codeBlock', 'code block') + '\n```');
    message.push(localizeMessage('help.formatting.syntax', '### Syntax Highlighting\n\nTo add syntax highlighting, type the language to be highlighted after the ``` at the beginning of the code block. ZeroChat also offers four different code themes (GitHub, Solarized Dark, Solarized Light, Monokai) that can be changed in **Account Settings** > **Display** > **Theme** > **Custom Theme** > **Center Channel Styles**'));
    ...
    message.push('`' + localizeMessage('help.formatting.linkEx', '[Check out ZeroChat!](/)') + '`');
    message.push(localizeMessage('help.formatting.renders', 'Renders as:') + ' ' + localizeMessage('help.formatting.linkEx', '[Check out ZeroChat!](/)'));
