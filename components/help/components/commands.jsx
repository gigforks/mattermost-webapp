...
export default function HelpCommands() {
    ...
    message.push(localizeMessage('help.commands.intro', 'Slash commands perform operations in ZeroChat by typing into the text input box. Enter a `/` followed by a command and some arguments to perform actions.\n\nBuilt-in slash commands come with all ZeroChat installations and custom slash commands are configurable to interact with external applications. Learn about configuring custom slash commands on the [developer slash command documentation page](/).'));
    message.push(localizeMessage('help.commands.builtin', '## Built-in Commands\nThe following slash commands are available on all ZeroChat installations:'));
    ...
    message.push(localizeMessage('help.commands.custom2', 'Custom slash commands are disabled by default and can be enabled by the System Admin in the **System Console** > **Integrations** > **Webhooks and Commands**. Learn about configuring custom slash commands on the [developer slash command documentation page](/).'));
