...
export default function HelpMessaging() {
    ...
    message.push(localizeMessage('help.messaging.write', '**Write messages** using the text input box at the bottom of ZeroChat. Press ENTER to send a message. Use SHIFT+ENTER to create a new line without sending a message.'));
    ...
    message.push(localizeMessage('help.messaging.attach', '**Attach files** by dragging and dropping into ZeroChat or clicking the attachment icon in the text input box.'));
